...
<% 
    ArrayList<Object> produits = (ArrayList<Object>) request.getAttribute("materiels");
%>
<!DOCTYPE html>
<html lang="en">
    <head>
  ...
  <h3>Produits disponibles</h3>
                    ...
                    <form action="./PrixConseillerProduitController" method="get"> 
                 <div class="produit">
                    <select name="id">
                    <% for (Object o : produits) {
                        Produits produit = (Produits) o;
                    %>
                        <option value="<%= produit.getProduit_id() %>">    <p><%= produit.getProduit_label() %></p></option>
                    <% } %>
                    
                    <input type="submit" value="Prix Conseiller">
                    </select>
                        </div>
